  ...
  return (
    ...
    >
      <GridLayout additional_class="relative">
        <div className="hidden md:block absolute top-[-40px] left-[-40px] w-[1px] h-[90%] bg_v_line"></div>
        <div className="hidden md:block absolute top-[-40px] right-[-40px] w-[1px] h-[90%] bg_v_line"></div>
        <PrismicRichText field={slice.primary.title} />
        <BlocProjects />
        <div className="hidden md:block absolute bottom-[-40px] left-0 w-[80%] h-[1px] bg_h_line"></div>
