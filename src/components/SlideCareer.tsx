    ...
    <>
      <Drawer>
        <DrawerTrigger asChild>
          <div className="group/slide relative h-full slide_gradient text-white/95 p-3 xs:p-6 pt-10 xl:p-10 xl:pt-10 rounded-xl overflow-hidden cursor-pointer">
        ...
        <DrawerContent className="dark:bg-secondary mb-4 dark:border-white/15">
          <div className="flex flex-col md:flex-row gap-4 w-full border-t border-b border-border/50 dark:border-white/15 ">
            <div className="shrink-0  relative p-8 pb-16 max-md:border-b border-r border-border/50 dark:border-white/15 ">
              ...
              <p className="text-black/75 dark:text-white/75 font-bold text-base xl:text-xl">
                {slice.primary.date}
              </p>
              <DrawerTitle className="font-bold text-2xl xl:text-3xl mb-2">
                {slice.primary.job_title}
              </DrawerTitle>

              <p className="font-medium text-base xl:text-xl mb-4">
